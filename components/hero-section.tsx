    ...
    <div className="container mx-auto px-12 pt-18 pb-48">
      <div className="text-primary-foreground tracking-widest w-fit relative">
        ...
        <div className="flex flex-col mb-22">
          <h1 className="text-8xl font-semibold font-montserrat opacity-0 animate-fadeInDown">
            PRECISION
          </h1>
        ...
        <div className=" text-xl font-semibold opacity-0 animate-fadeInDownDelay5">
          ...
          <p className="mb-1 text-base opacity-0 animate-fadeInUpDelay7">
            粒子測定のために必要な前処理装置、超音波分散機および、測定データ検証用のデータ解析システムなど、
          </p>
          <p className="mb-12 text-base opacity-0 animate-fadeInDownDelay9">
            トータルでサポートいたします。
          </p>
